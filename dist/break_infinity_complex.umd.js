(function(global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require("break_infinity.js")) :
    typeof define === 'function' && define.amd ? define(["break_infinity.js"], factory) :
    (global = global || self, global.Complex = factory(global.Decimal));
}(this, (function(decimal) {
  "use strict";

  function _interopDefaultLegacy(e) { return e && typeof e === 'object' && 'default' in e ? e.default : e; }

  const Decimal = /*#__PURE__*/ _interopDefaultLegacy(decimal);
  ...
  Complex.prototype.div = function(comp) {
    if (comp.eqz()) return Complex.fromComplex(Complex.Infinity);
  ...
  Complex.prototype.tan = function() {
    return this.timesI().exp().minus(this.neg().timesI().exp()).div(this.timesI().exp().add(this.neg().timesI().exp())).divI();
  }
  
  Complex.prototype.cot = function() {
    return this.ran().recip();
  }
  ...
  Complex.prototype.toString = function() {
    if (this.im.eq(0)) return `${this.re}`;
